 ...
 * RCS:          $Id: PctDownloadImprovementItem.java,v 1.4 2010/03/29 16:48:03 drc915 Exp $
 ...
 */
public class PctDownloadImprovementItem extends CoreTableColumn implements
	TableCellRefreshListener  {


/** Default Constructor */
  public PctDownloadImprovementItem() {
    super("downloadImprovement", POSITION_LAST, 100, OnoView.NEARBY_PEERS);
  ...
  public void refresh(TableCell cell) {
	  ...
	  op = OnoPeerManager.getInstance().getOnoPeer(op.getIp());
	    ...
	    String sText = op.getRelativeDownloadPerformance();
