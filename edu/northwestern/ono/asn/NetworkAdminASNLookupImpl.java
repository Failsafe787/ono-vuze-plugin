...
package edu.northwestern.ono.asn;
...
NetworkAdminASNLookupImpl 
{
		...
		String		result )
	{
		...
		String country = (String) map.get("cc");
		...
		return( new NetworkAdminASNImpl( as, asn, bgp_prefix, country ));
	}
	...
	public void setAddress(InetAddress publicAddress) {
		if (this.address==null || !this.address.equals(publicAddress)){
