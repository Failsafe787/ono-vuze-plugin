       ...
       implements TableColumnCore
{
  ...
  public TableContextMenuItem addContextMenuItem(String key) {
    ...
    TableContextMenuItemImpl parent = null;
    // Hack.. should be using our own implementation..
    TableContextMenuItemImpl item = new TableContextMenuItemImpl(parent, key);
    menuItems.add(item);
    return item;
  }
...
//		}
  ...
  public void setTableID(String tableID) {
	...
	public void removeColumnExtraInfoListener(
			TableColumnExtraInfoListener listener) {
		// TODO Auto-generated method stub
